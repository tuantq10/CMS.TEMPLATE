...
export default class UploadFileResumable extends React.Component {
    ...
    componentDidMount = () => {
        ...
        let ResumableField = new Resumablejs({
            ...
            throttleProgressCallbacks: this.props.throttleProgressCallbacks,
            fileParameterName: this.props.fileParameterName,
            chunkNumberParameterName: this.props.chunkNumberParameterName,
...
UploadFileResumable.defaultProps = {
    maxFiles: undefined,
